...
const passenger = "dDanIel" // Convert all to lowercase
const passengerLower = passenger.toLowerCase()

console.log(passengerLower.slice(1))

//Combine lower with corrected
let passengerCorrect = passengerLower.slice(1)
let passengerCorrect2 =
  passengerCorrect.charAt(0).toUpperCase() + passengerCorrect
